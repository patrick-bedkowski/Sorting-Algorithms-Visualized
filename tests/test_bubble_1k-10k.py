...
def test_bubble_tadeusz_1000(benchmark):
    result = benchmark(bubble_sort, data1000)
    assert result == sorted(data1000)


def test_bubble_tadeusz_2000(benchmark):
    result = benchmark(bubble_sort, data2000)
    assert result == sorted(data2000)


def test_bubble_tadeusz_3000(benchmark):
    result = benchmark(bubble_sort, data3000)
    assert result == sorted(data3000)


def test_bubble_tadeusz_4000(benchmark):
    result = benchmark(bubble_sort, data4000)
    assert result == sorted(data4000)


def test_bubble_tadeusz_5000(benchmark):
    result = benchmark(bubble_sort, data5000)
    assert result == sorted(data5000)


def test_bubble_tadeusz_6000(benchmark):
    result = benchmark(bubble_sort, data6000)
    assert result == sorted(data6000)


def test_bubble_tadeusz_7000(benchmark):
    result = benchmark(bubble_sort, data7000)
    assert result == sorted(data7000)


def test_bubble_tadeusz_8000(benchmark):
    result = benchmark(bubble_sort, data8000)
    assert result == sorted(data8000)


def test_bubble_tadeusz_9000(benchmark):
    result = benchmark(bubble_sort, data9000)
    assert result == sorted(data9000)


def test_bubble_tadeusz_10000(benchmark):
    result = benchmark(bubble_sort, data10000)
